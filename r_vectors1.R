...
x7b
length(x7b)
x7b = seq(from=10, to=20, length.out = 16)
x7b
#multiple functions-------
...
# Male % approx 60%
y2c = sample(x=y2a, size=90, replace=T, prob=c(.6,.4))
y2c
...
quantile(n2, p=c(.1, .7, .5))  #10th & 70th percentile
...
table(n2cut)
breaks2 = c(0,50,60,70,80,90,100)
n2cut = cut(n2, breaks= breaks2)
table(n2cut)
