...
df1[df1$gender == 'M' & df1$marks1 > 80, c('rollno', 'name','gender','marks1','marks2')]#mycodeAshwin
df1[df1$grades %in% c('A','C') & df1$marks2 > 80 & df1$marks1 < 75, c('rollno', 'name','gender', 'grades', 'marks1', 'marks2')]  #& is for and and | is for 'or'
